...
{
    public partial class COrder : Form
    {
        int tax = 0;
        int finalcost = 0;
        int SrNo = 0;
        ...
        void GetPrice()
        {
            ...
            else
            {
                int price = 0;
                SqlConnection con = new SqlConnection(cs1);
                string query = "select Price from CartList2 where name = @name";
        ...
        void GetDiscount()
        {
            ...
            else
            {
                ...
                SqlConnection con = new SqlConnection(cs1);
                string query = "select Discount from CartList2 where name = @name";
                SqlDataAdapter sda = new SqlDataAdapter(query, con);
        ...
        {
            SqlConnection con = new SqlConnection(cs1);
            string query1 = "select * from customer_Details2 where Id = @id";
            ...
            else
            {
                ...
                string query = "insert into customer_Details2 values(@id,@name,@Dept,@Year,@Semester,@Address,@Phone,@Email,@Product,@Price,@Quantity,@Rent_Date)";
