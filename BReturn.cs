...
namespace WindowsFormsApp3
{
    public partial class BReturn : Form
    {
        ...
        void GetIds()
        {
            ...
            string query = "select * from Return_Item1";
        ...
        void GetCname()
        {
            ...
            else
            {
                ...
                string name = null;
                SqlConnection con = new SqlConnection(cs1);
                string query = "select name from Return_Item1 where Id = @id";
        ...
        void GetCDept()
        {
            ...
            else
            {
                ...
                string dept = null;
                SqlConnection con = new SqlConnection(cs1);
                string query = "select Dept from Return_Item1 where Id = @id";
                SqlDataAdapter sda = new SqlDataAdapter(query, con);
        ...
        void GetProduct()
        {
            ...
            else
            {
                ...
                string item = null;
                SqlConnection con = new SqlConnection(cs1);
                string query = "select product from Return_Item1 where Id = @id";
                SqlDataAdapter sda = new SqlDataAdapter(query, con);
        ...
        void GetCYear()
        {
            ...
            else
            {
                ...
                int year = 0;
                SqlConnection con = new SqlConnection(cs1);
                string query = "select Year from Return_Item1 where Id = @id";
                SqlDataAdapter sda = new SqlDataAdapter(query, con);
        ...
        void GetCsemester()
        {
            ...
            else
            {
                ...
                int sem = 0;
                SqlConnection con = new SqlConnection(cs1);
                string query = "select semester from Return_Item1 where Id = @id";
                SqlDataAdapter sda = new SqlDataAdapter(query, con);
        ...
        void GetQuantity()
        {
            ...
            else
            {
                ...
                string quan = null;
                SqlConnection con = new SqlConnection(cs1);
                string query = "select Quantity from Return_Item1 where Id = @id";
                SqlDataAdapter sda = new SqlDataAdapter(query, con);
        ...
        void GetRentD()
        {
            ...
            else
            {
                ...
                string RD = null;
                SqlConnection con = new SqlConnection(cs1);
                string query = "select Rent_Date from Return_Item1 where Id = @id";
                SqlDataAdapter sda = new SqlDataAdapter(query, con);
        ...
        void GetReturnD()
        {
            ...
            else
            {
                ...
                string RD = null;
                SqlConnection con = new SqlConnection(cs1);
                string query = "select Return_Date from Return_Item1 where Id = @id";
                SqlDataAdapter sda = new SqlDataAdapter(query, con);
        ...
        {
            SqlConnection con = new SqlConnection(cs1);
            string query1 = "select * from Return_Details1";
        ...
        {
            SqlConnection con = new SqlConnection(cs1);
            string query1 = "select * from Return_Details1 where Id = @id";
            ...
            else
            {
                ...
                string query = "insert into Return_Details1  values(@id,@name,@Dept,@Year,@Semester,@product,@Quantity,@Rent_Date,@Return_Date)";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(cs1);
            string query = "Update  Return_Details1 set  @id= id,name = @name,Dept=@Dept,Year = @Year,Semester = @Semester,product = @product,Quantity = @Quantity,Rent_Date = @Rent_Date,Return_Date = @Return_Date where Id = @id ";
            SqlCommand cmd = new SqlCommand(query, con);
        ...
        {
            SqlConnection con = new SqlConnection(cs1);
            string query = "Delete from  Return_Details1  where Id = @id ";
            SqlCommand cmd = new SqlCommand(query, con);
