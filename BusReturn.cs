...
{
    public partial class BusReturn : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query1 = "select * from Return_Item1 where Id = @id";
            ...
            else
            {
                ...
                string query = "insert into Return_Item1  values(@id,@name,@Dept,@Year,@Semester,@product,@Quantity,@Rent_Date,@Return_Date)";
