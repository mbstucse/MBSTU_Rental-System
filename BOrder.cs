...
namespace WindowsFormsApp3
{
    public partial class BOrder : Form
    {
        ...
        void GetProduct()
        {
            ...
            string query = "select * from CartList1";
        ...
        void GetPrice()
        {
            ...
            else
            {
                int price = 0;
                SqlConnection con = new SqlConnection(cs1);
                string query = "select Price from CartList1 where name = @name";
        ...
        void GetDiscount()
        {
            ...
            else
            {
                ...
                SqlConnection con = new SqlConnection(cs1);
                string query = "select Discount from CartList1 where name = @name";
                SqlDataAdapter sda = new SqlDataAdapter(query, con);
        ...
        {
            SqlConnection con = new SqlConnection(cs1);
            string query1 = "select * from customer_Details1 where Id = @id";
            ...
            else
            {
                ...
                string query = "insert into customer_Details1 values(@id,@name,@Dept,@Year,@Semester,@Address,@Phone,@Email,@Product,@Price,@Quantity,@Rent_Date)";
