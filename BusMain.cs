...
namespace WindowsFormsApp3
{
    public partial class BusMain : Form
    {
        ...
        void BindGridView()
        {
            ...
            string query1 = "select * from BusList";
        ...
        {
            SqlConnection con = new SqlConnection(cs1);
            string query1 = "select * from BusList where Id = @id";
            ...
            else
            {
                ...
                string query = "insert into BusList values(@id,@name,@Model,@Price,@Quantity,@Avaiable,@Discount)";
        ...
        {
            SqlConnection con = new SqlConnection(cs1);
            string query = "Update BusList set Id =@id,Name = @name,Model = @Model,Price = @Price,Quantity = @Quantity,Available = @Avaiable,Discount = @Discount where Id = @id ";
            SqlCommand cmd = new SqlCommand(query, con);
        ...
        {
            SqlConnection con = new SqlConnection(cs1);
            string query = "Delete from BusList where Id = @id";
            SqlCommand cmd = new SqlCommand(query, con);
