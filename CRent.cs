...
{
    public partial class CRent : Form
    {
        ...
        void GetIds()
        {
            ...
            string query = "select * from customer_Details2";
        ...
        void GetCname()
        {
            ...
            else
            {
                ...
                string name = null;
                SqlConnection con = new SqlConnection(cs1);
                string query = "select name from customer_Details2 where Id = @id";
        ...
        void GetCDept()
        {
            ...
            else
            {
                ...
                string dept = null;
                SqlConnection con = new SqlConnection(cs1);
                string query = "select Dept from customer_Details2 where Id = @id";
                SqlDataAdapter sda = new SqlDataAdapter(query, con);
        ...
        void GetProduct()
        {
            ...
            else
            {
                ...
                string item = null;
                SqlConnection con = new SqlConnection(cs1);
                string query = "select product from customer_Details2 where Id = @id";
                SqlDataAdapter sda = new SqlDataAdapter(query, con);
        ...
        void GetCYear()
        {
            ...
            else
            {
                ...
                int year = 0;
                SqlConnection con = new SqlConnection(cs1);
                string query = "select Year from customer_Details2 where Id = @id";
                SqlDataAdapter sda = new SqlDataAdapter(query, con);
        ...
        void GetCsemester()
        {
            ...
            else
            {
                ...
                int sem = 0;
                SqlConnection con = new SqlConnection(cs1);
                string query = "select semester from customer_Details2 where Id = @id";
                SqlDataAdapter sda = new SqlDataAdapter(query, con);
        ...
        void GetQuantity()
        {
            ...
            else
            {
                ...
                string quan = null;
                SqlConnection con = new SqlConnection(cs1);
                string query = "select Quantity from customer_Details2 where Id = @id";
                SqlDataAdapter sda = new SqlDataAdapter(query, con);
        ...
        void GetRentD()
        {
            ...
            else
            {
                ...
                string RD = null;
                SqlConnection con = new SqlConnection(cs1);
                string query = "select Rent_Date from customer_Details2 where Id = @id";
                SqlDataAdapter sda = new SqlDataAdapter(query, con);
        ...
        {
            SqlConnection con = new SqlConnection(cs1);
            string query1 = "select * from Rent_Details2";
        ...
        {
            SqlConnection con = new SqlConnection(cs1);
            string query1 = "select * from Rent_Details2 where Id = @id";
            ...
            else
            {
                ...
                string query = "insert into  Rent_Details2 values(@id,@name,@Dept,@Year,@Semester,@product,@Quantity,@Rent_Date)";
        ...
        {
            SqlConnection con = new SqlConnection(cs1);
            string query = "Update  Rent_Details2 set  @id= id,name = @name,Dept=@Dept,Year = @Year,Semester = @Semester,product = @product,Quantity = @Quantity,Rent_Date = @Rent_Date where Id = @id ";
            SqlCommand cmd = new SqlCommand(query, con);
        ...
        {
            SqlConnection con = new SqlConnection(cs1);
            string query = "Delete from  Rent_Details2  where Id = @id ";
            SqlCommand cmd = new SqlCommand(query, con);
