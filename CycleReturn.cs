...
{
    public partial class CycleReturn : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query1 = "select * from Return_Item2 where Id = @id";
            ...
            else
            {
                ...
                string query = "insert into Return_Item2  values(@id,@name,@Dept,@Year,@Semester,@product,@Quantity,@Rent_Date,@Return_Date)";
