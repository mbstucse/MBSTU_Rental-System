...
namespace WindowsFormsApp3
{
    public partial class Bub : Form
    {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            string query = "select * from BusList where Name like @name + '%'";
        ...
        {
            SqlConnection con = new SqlConnection(cs1);
            string query1 = "select * from CartList1 where  Id = @id";
            ...
            else
            {
                ...
                string query = "insert into CartList1 values(@id,@name,@Model,@Price,@Quantity,@Avaiable,@Discount)";
        ...
        {
            SqlConnection con = new SqlConnection(cs1);
            string query = "Delete from CartList1 where Id = @id ";
            SqlCommand cmd = new SqlCommand(query, con);
